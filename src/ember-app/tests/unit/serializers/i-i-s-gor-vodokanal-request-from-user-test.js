...
moduleForModel('i-i-s-gor-vodokanal-request-from-user', 'Unit | Serializer | i-i-s-gor-vodokanal-request-from-user', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-gor-vodokanal-request-from-user',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
